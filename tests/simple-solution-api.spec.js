...
test_1.test.describe('Simple solution API tests', () => {
  ...
  ;(0, test_1.test)(
    'post order with correct data should receive code 200 - process full body',
    async ({ request }) => {
      // prepare request body with dto pattern
      const requestBody = order_dto_1.OrderDto.createOrderWithRandomData()
      const response = await request.post(serviceURL, {
  ...
  ;(0, test_1.test)(
    'post order with unexpected fields should ignore extra fields',
    async ({ request }) => {
      const requestBody = order_dto_1.OrderDto.createOrderWithRandomData()
  ...
  ;(0, test_1.test)(
    'post order with headers should include headers in response',
    async ({ request }) => {
      const headers = {
